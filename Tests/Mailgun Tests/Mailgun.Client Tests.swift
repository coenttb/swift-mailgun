    ...
    func wiring() async {
        let messages = Mailgun.Messages.Client<Mailgun.Fixture.Failure>(
            ...
            retrieve: {
                (
                    _: String
                ) async throws(Mailgun.Fixture.Failure) -> Mailgun.Messages.StoredMessage
                in throw .expected
            },
            queueStatus: {
        ...
        let mailingLists = Mailgun.Lists.Client<Mailgun.Fixture.Failure>(
            create: {
                (
                    _: Mailgun.Lists.List.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Lists.List.Create.Response in throw .expected
            },
            list: {
                (
                    _: Mailgun.Lists.List.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            members: {
                (
                    _: EmailAddress,
                    _: Mailgun.Lists.List.Members.Request
                ) async throws(Mailgun
                    .Fixture.Failure) -> Mailgun.Lists.List.Members.Response in throw .expected
            },
            addMember: {
                (
                    _: EmailAddress,
                    _: Mailgun.Lists.Member.Add.Request
                ) async throws(Mailgun.Fixture
                    .Failure) -> Mailgun.Lists.Member.Add.Response in throw .expected
            },
            bulkAdd: {
                (
                    _: EmailAddress,
                    _: [Mailgun.Lists.Member.Bulk],
                    _: Bool?
                ) async throws(Mailgun
            ...
            updateMember: {
                (
                    _: EmailAddress,
                    _: EmailAddress,
                    _: Mailgun.Lists.Member.Update.Request
                )
            ...
            update: {
                (
                    _: EmailAddress,
                    _: Mailgun.Lists.List.Update.Request
                ) async throws(Mailgun.Fixture
            ...
            pages: {
                (
                    _: Int?
                ) async throws(Mailgun.Fixture.Failure) -> Mailgun.Lists.List.Pages.Response
                in throw .expected
            },
            memberPages: {
                (
                    _: EmailAddress,
                    _: Mailgun.Lists.List.Members.Pages.Request
                ) async throws(Mailgun
        ...
        let suppressionsBounces = Mailgun.Suppressions.Bounces.Client<Mailgun.Fixture.Failure>(
            ...
            list: {
                (
                    _: Mailgun.Suppressions.Bounces.List.Request?
                ) async throws(Mailgun.Fixture
                    .Failure) -> Mailgun.Suppressions.Bounces.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Suppressions.Bounces.Create.Request
                ) async throws(Mailgun.Fixture
        ...
        >(
            importList: {
                (
                    _: Mailgun.Suppressions.Complaints.Import.Request
                ) async throws(Mailgun.Fixture
            ...
            list: {
                (
                    _: Mailgun.Suppressions.Complaints.List.Request?
                ) async throws(Mailgun.Fixture
                    .Failure) -> Mailgun.Suppressions.Complaints.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Suppressions.Complaints.Create.Request
                ) async throws(Mailgun.Fixture
        ...
        >(
            ...
            list: {
                (
                    _: Mailgun.Suppressions.Unsubscribe.List.Request?
                ) async throws(Mailgun.Fixture
                    .Failure) -> Mailgun.Suppressions.Unsubscribe.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Suppressions.Unsubscribe.Create.Request
                ) async throws(Mailgun.Fixture
        ...
        let suppressionsAllowlist = Mailgun.Suppressions.Allowlist.Client<Mailgun.Fixture.Failure>(
            ...
            list: {
                (
                    _: Mailgun.Suppressions.Allowlist.List.Request?
                ) async throws(Mailgun.Fixture
                    .Failure) -> Mailgun.Suppressions.Allowlist.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Suppressions.Allowlist.Create.Request
                ) async throws(Mailgun.Fixture
        ...
        let domainsDomains = Mailgun.Domains.Domains.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Mailgun.Domains.Domains.List.Request?
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Domains.Domains.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Domains.Domains.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: Domain,
                    _: Mailgun.Domains.Domains.Update.Request
                ) async throws(Mailgun.Fixture
        ...
        let domainKeys = Mailgun.Domains.DomainKeys.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Mailgun.Domains.DomainKeys.List.Request?
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Domains.DomainKeys.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Domains.DomainKeys.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Domains.DomainKeys.Create.Response in throw .expected
            },
            delete: {
                (
                    _: Mailgun.Domains.DomainKeys.Delete.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            setDkimAuthority: {
                (
                    _: String,
                    _: Mailgun.Domains.DomainKeys.SetDkimAuthority.Request
                )
                    async throws(Mailgun.Fixture.Failure)
            ...
            setDkimSelector: {
                (
                    _: String,
                    _: Mailgun.Domains.DomainKeys.SetDkimSelector.Request
                )
                    async throws(Mailgun.Fixture.Failure)
        ...
        let domainTracking = Mailgun.Domains.Domains.Tracking.Client<Mailgun.Fixture.Failure>(
            ...
            updateClick: {
                (
                    _: Domain,
                    _: Mailgun.Domains.Domains.Tracking.UpdateClick.Request
                )
                    async throws(Mailgun.Fixture.Failure)
            ...
            updateOpen: {
                (
                    _: Domain,
                    _: Mailgun.Domains.Domains.Tracking.UpdateOpen.Request
                )
                    async throws(Mailgun.Fixture.Failure)
            ...
            updateUnsubscribe: {
                (
                    _: Domain,
                    _: Mailgun.Domains.Domains.Tracking.UpdateUnsubscribe.Request
                )
                    async throws(Mailgun.Fixture.Failure)
        ...
        let dkimSecurity = Mailgun.Domains.DKIM_Security.Client<Mailgun.Fixture.Failure>(
            updateRotation: {
                (
                    _: Domain,
                    _: Mailgun.Domains.DKIM_Security.Rotation.Update.Request
                )
                    async throws(Mailgun.Fixture.Failure)
        ...
        let webhooks = Mailgun.Webhooks.Client<Mailgun.Fixture.Failure>(
            ...
            get: {
                (
                    _: Mailgun.Webhooks.WebhookType
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Webhooks.Get.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Webhooks.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: Mailgun.Webhooks.WebhookType,
                    _: Mailgun.Webhooks.Update.Request
                )
        ...
        let routes = Mailgun.Routes.Client<Mailgun.Fixture.Failure>(
            create: {
                (
                    _: Mailgun.Routes.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: String,
                    _: Mailgun.Routes.Update.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            delete: {
                (
                    _: String
                ) async throws(Mailgun.Fixture.Failure) -> Mailgun.Routes.Delete.Response
                in throw .expected
            },
            match: {
                (
                    _: String
                ) async throws(Mailgun.Fixture.Failure) -> Mailgun.Routes.Match.Response
                in throw .expected
            }
        )
        ...
        let templates = Mailgun.Templates.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Mailgun.Templates.List.Request?
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Templates.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Templates.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            versions: {
                (
                    _: String,
                    _: Mailgun.Templates.Versions.Request?
                ) async throws(Mailgun.Fixture
            ...
            createVersion: {
                (
                    _: String,
                    _: Mailgun.Templates.Version.Create.Request
                ) async throws(Mailgun
            ...
            get: {
                (
                    _: String,
                    _: Mailgun.Templates.Get.Request?
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: String,
                    _: Mailgun.Templates.Update.Request
                ) async throws(Mailgun.Fixture
            ...
            updateVersion: {
                (
                    _: String,
                    _: String,
                    _: Mailgun.Templates.Version.Update.Request
                )
                    async throws(Mailgun.Fixture.Failure)
            ...
            copyVersion: {
                (
                    ...
                    _: String,
                    _: String,
                    _: Mailgun.Templates.Version.Copy.Request?
                )
        ...
        let reportingEvents = Mailgun.Reporting.Events.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Mailgun.Reporting.Events.List.Query?
                ) async throws(Mailgun.Fixture.Failure)
        ...
        let reportingStats = Mailgun.Reporting.Stats.Client<Mailgun.Fixture.Failure>(
            total: {
                (
                    _: Mailgun.Reporting.Stats.Total.Request
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Reporting.Stats.StatsList in throw .expected
            },
            filter: {
                (
                    _: Mailgun.Reporting.Stats.Filter.Request
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Reporting.Stats.StatsList in throw .expected
            },
            aggregateProviders: {
        ...
        let reportingMetrics = Mailgun.Reporting.Metrics.Client<Mailgun.Fixture.Failure>(
            getAccountMetrics: {
                (
                    _: Mailgun.Reporting.Metrics.GetAccountMetrics.Request
                ) async throws(Mailgun
            ...
            getAccountUsageMetrics: {
                (
                    _: Mailgun.Reporting.Metrics.GetAccountUsageMetrics.Request
                ) async throws(Mailgun
        ...
        let reportingTags = Mailgun.Reporting.Tags.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Mailgun.Reporting.Tags.List.Request?
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: String,
                    _: Mailgun.Reporting.Tags.Update.Request
                ) async throws(Mailgun.Fixture
            ...
            stats: {
                (
                    _: String,
                    _: Mailgun.Reporting.Tags.Stats.Request
                ) async throws(Mailgun.Fixture
            ...
            aggregates: {
                (
                    _: String,
                    _: Mailgun.Reporting.Tags.Aggregates.Request
                ) async throws(Mailgun
        ...
        let reportingLogs = Mailgun.Reporting.Logs.Client<Mailgun.Fixture.Failure>(
            analytics: {
                (
                    _: Mailgun.Reporting.Logs.Analytics.Request
                ) async throws(Mailgun.Fixture.Failure)
        ...
        let ips = Mailgun.IPs.Client<Mailgun.Fixture.Failure>(
            ...
            listDomains: {
                (
                    _: String
                ) async throws(Mailgun.Fixture.Failure) -> Mailgun.IPs.DomainList.Response
                in throw .expected
            },
            assignDomain: {
                (
                    _: String,
                    _: Mailgun.IPs.AssignDomain.Request
                ) async throws(Mailgun.Fixture
            ...
            assignIPBand: {
                (
                    _: String,
                    _: Mailgun.IPs.IPBand.Request
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.IPs.IPBand.Response in throw .expected
            },
            requestNew: {
                (
                    _: Mailgun.IPs.RequestNew.Request
                ) async throws(Mailgun.Fixture.Failure)
        ...
        let ipAddressWarmup = Mailgun.IPAddressWarmup.Client<Mailgun.Fixture.Failure>(
            ...
            create: {
                (
                    _: String,
                    _: Mailgun.IPAddressWarmup.Create.Request
                ) async throws(Mailgun.Fixture
        ...
        let ipPools = Mailgun.IPPools.Client<Mailgun.Fixture.Failure>(
            ...
            create: {
                (
                    _: Mailgun.IPPools.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            update: {
                (
                    _: String,
                    _: Mailgun.IPPools.Update.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            delete: {
                (
                    _: String,
                    _: Mailgun.IPPools.Delete.Request?
                ) async throws(Mailgun.Fixture
        ...
        let dynamicIPPools = Mailgun.DynamicIPPools.Client<Mailgun.Fixture.Failure>(
            listHistory: {
                (
                    _: Mailgun.DynamicIPPools.HistoryList.Request
                ) async throws(Mailgun.Fixture
        ...
        let ipAllowlist = Mailgun.IPAllowlist.Client<Mailgun.Fixture.Failure>(
            ...
            update: {
                (
                    _: Mailgun.IPAllowlist.UpdateRequest
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.IPAllowlist.SuccessResponse in throw .expected
            },
            add: {
                (
                    _: Mailgun.IPAllowlist.AddRequest
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.IPAllowlist.SuccessResponse in throw .expected
            },
            delete: {
                (
                    _: Mailgun.IPAllowlist.DeleteRequest
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.IPAllowlist.SuccessResponse in throw .expected
            }
        )
        ...
        let keys = Mailgun.Keys.Client<Mailgun.Fixture.Failure>(
            ...
            addPublicKey: {
                (
                    _: Mailgun.Keys.PublicKey.Request
                ) async throws(Mailgun.Fixture.Failure)
        ...
        let credentials = Mailgun.Credentials.Client<Mailgun.Fixture.Failure>(
            list: {
                (
                    _: Domain,
                    _: Mailgun.Credentials.List.Request?
                ) async throws(Mailgun.Fixture
            ...
            create: {
                (
                    _: Domain,
                    _: Mailgun.Credentials.Create.Request
                ) async throws(Mailgun.Fixture
            ...
            update: {
                (
                    _: Domain,
                    _: String,
                    _: Mailgun.Credentials.Update.Request
                ) async throws(Mailgun
            ...
            updateMailbox: {
                (
                    _: Domain,
                    _: String,
                    _: Mailgun.Credentials.Mailbox.Update.Request
                )
                    async throws(Mailgun.Fixture.Failure)
        ...
        let subaccounts = Mailgun.Subaccounts.Client<Mailgun.Fixture.Failure>(
            ...
            list: {
                (
                    _: Mailgun.Subaccounts.List.Request?
                ) async throws(Mailgun.Fixture.Failure)
                    -> Mailgun.Subaccounts.List.Response in throw .expected
            },
            create: {
                (
                    _: Mailgun.Subaccounts.Create.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            disable: {
                (
                    _: String,
                    _: Mailgun.Subaccounts.Disable.Request?
                ) async throws(Mailgun.Fixture
            ...
            updateFeatures: {
                (
                    _: String,
                    _: Mailgun.Subaccounts.Features.Update.Request
                ) async throws(Mailgun
        ...
        let customMessageLimit = Mailgun.CustomMessageLimit.Client<Mailgun.Fixture.Failure>(
            ...
            setMonthlyLimit: {
                (
                    _: Mailgun.CustomMessageLimit.Monthly.Set.Request
                ) async throws(Mailgun.Fixture
        ...
        let accountManagement = Mailgun.AccountManagement.Client<Mailgun.Fixture.Failure>(
            updateAccount: {
                (
                    _: Mailgun.AccountManagement.Update.Request
                ) async throws(Mailgun.Fixture.Failure)
            ...
            addSAMLOrganization: {
                (
                    _: Mailgun.AccountManagement.SAML.Organization.Add.Request
                ) async throws(Mailgun
